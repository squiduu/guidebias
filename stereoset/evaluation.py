...
from stereoset_dataloader import StereoSet
...
def parse_file(gold_file, predictions_file):
    score_evaluator = ScoreEvaluator(gold_file_path=gold_file, predictions_file_path=predictions_file)
...
if __name__ == "__main__":
    ...
    if args.predictions_dir is not None:
        ...
        for prediction_file in glob.glob(predictions_dir + "*.json"):
            ...
            parse_file(f"./data/test.json", prediction_file)
    else:
        parse_file(f"./data/test.json", args.predictions_file)
